...
void setup() {
    ...
    //multi strip led line
    //add next line like this: FastLED.addLeds<LED_TYPE, LED_PIN1, COLOR_ORDER>(leds, NUM_LEDS1).setCorrection( TypicalLEDStrip );
    //change only LED_PIN1
